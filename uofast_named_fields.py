...
Option A - monkey-patch (zero call-site changes)::
    ...
    import uopy
    from uofast_named_fields import patch_uopy_file
    patch_uopy_file()
...
Option B - subclass::
    ...
    from uofast_named_fields import NamedFieldsMixin
    import uopy
...
Option C - use SmartFile directly::
    ...
    from uofast_named_fields import SmartFile
    import uopy
